...
Before looking at the geographical distribution of voting partipcation by race, this table gives a brief introduction as to what to expect. White voters have the highest voting participation rate by, making up, on average, 75.5% of a congressional district's total voting rate. This voting participation rate is then followed by Hispanic, Black, Asian, and Multiracial voters. 
