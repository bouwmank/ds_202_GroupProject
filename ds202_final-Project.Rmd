...
**Overview**
    This data set comes from the census beaure, it is collected datd for the 2018 midterm election. They have the overall population of people who are of Voting age with in the district as well as the number of votes cast. In other tables they have data on that districts population such as age, education, sex, poverty status, race, and geographic area. We are looking at those specifics to see what has the strongest corrolation for voter paricpation.
